...
const _TransactiontransactionTypeEnumValueMap = {
  r'remittance': r'remittance',
  r'income': r'income',
  r'expenditure': r'expenditure',
};
const _TransactiontransactionTypeValueEnumMap = {
  r'remittance': TransactionType.remittance,
  r'income': TransactionType.income,
  r'expenditure': TransactionType.expenditure,
};
...
extension TransactionQueryFilter
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> toWalletEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'toWallet',
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> toWalletBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByToWallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toWallet', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByToWalletDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toWallet', Sort.desc);
    });
  }
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByToWallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toWallet', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByToWalletDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toWallet', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByToWallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'toWallet');
    });
  }
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, int?, QQueryOperations> toWalletProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'toWallet');
    });
  }
